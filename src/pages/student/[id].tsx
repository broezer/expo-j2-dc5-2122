        ...
        <article className="container max-w-full bg-white bg-opacity-95 text-black-85 p-4 m-4 rounded-xl">
          ...
          <section className="flex flex-wrap justify-center my-10">
            <h2 className="font-light italic text-xl text-gray-800 text-center w-4/5">
              "<span className="text-purple-600">How might we </span>{' '}
              <span className="font-semibold">{postData.hmw}</span>"
            </h2>
          </section>
          ...
          <section className="flex flex-wrap justify-center my-10 w-4/5 m-auto">
            <h2 className="uppercase text-xs text-green-600 font-bold w-full mb-4 text-center">
              Connect with us
            </h2>
            <a
              href={postData.teams}
          ...
          <section>
            <h4 className="text-xl font-black uppercase text-purple-600 my-6">
